...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'metadata.industries.it_communication' => 'string',
            'metadata.industries.manufacturing' => 'string',
            'metadata.industries.construction_realestate' => 'string',
            'metadata.industries.finance_insurance' => 'string',
            'metadata.industries.retail_wholesale' => 'string',
            'metadata.industries.service_restaurant' => 'string',
            'metadata.industries.logistics_transport' => 'string',
            'metadata.industries.media_advertising' => 'string',
            'metadata.industries.energy_environment' => 'string',
            'metadata.industries.medical_welfare' => 'string',
            'metadata.industries.education_research' => 'string',
            'metadata.industries.government_public' => 'string',
            'metadata.industries.consulting' => 'string',
            'metadata.industries.other' => 'string',
            'metadata.company_types.startup' => 'string',
            'metadata.company_types.sme' => 'string',
            'metadata.company_types.large_listed' => 'string',
            'metadata.company_types.foreign_affiliated' => 'string',
            'metadata.company_types.public_npo' => 'string',
            'metadata.company_types.freelance_sole' => 'string',
            'metadata.company_types.other' => 'string',
            'metadata.company_sizes.1-10' => 'string',
            'metadata.company_sizes.11-50' => 'string',
            'metadata.company_sizes.51-200' => 'string',
            'metadata.company_sizes.201-1000' => 'string',
            'metadata.company_sizes.1001-' => 'string',
            'metadata.skill_types.technical' => 'string',
            'metadata.skill_types.business' => 'string',
            'metadata.skill_types.industry' => 'string',
            'metadata.skill_types.language' => 'string',
            'metadata.skill_types.qualification' => 'string',
            'metadata.skill_types.knowledge' => 'string',
            'metadata.skill_types.soft_skill' => 'string',
            'metadata.skill_types.other' => 'string',
...
'metadata.industries.it_communication','metadata.industries.manufacturing','metadata.industries.construction_realestate','metadata.industries.finance_insurance','metadata.industries.retail_wholesale',
'metadata.industries.service_restaurant','metadata.industries.logistics_transport','metadata.industries.media_advertising','metadata.industries.energy_environment','metadata.industries.medical_welfare',
'metadata.industries.education_research','metadata.industries.government_public','metadata.industries.consulting','metadata.industries.other','metadata.company_types.startup',
'metadata.company_types.sme','metadata.company_types.large_listed','metadata.company_types.foreign_affiliated','metadata.company_types.public_npo','metadata.company_types.freelance_sole',
'metadata.company_types.other','metadata.company_sizes.1-10','metadata.company_sizes.11-50','metadata.company_sizes.51-200','metadata.company_sizes.201-1000',
'metadata.company_sizes.1001-','metadata.skill_types.technical','metadata.skill_types.business','metadata.skill_types.industry','metadata.skill_types.language',
'metadata.skill_types.qualification','metadata.skill_types.knowledge','metadata.skill_types.soft_skill','metadata.skill_types.other','queue.default',
...
'session.same_site','session.partitioned','concurrency.default','hashing.driver','hashing.bcrypt.rounds',
...
'sanctum.csrf-cookie',
'posts.index','posts.store','posts.show','posts.update','posts.destroy',
'posts.comments.index','posts.comments.store','users.show','users.posts','posts.like',
'posts.unlike','users.follow','users.unfollow','notifications.index','notifications.markAsRead',
...
'AWS_DEFAULT_REGION','AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','SANCTUM_STATEFUL_DOMAINS',
'REVERB_APP_ID','REVERB_APP_KEY','REVERB_APP_SECRET','REVERB_HOST','REVERB_PORT',
'REVERB_SCHEME','BROADCAST_DRIVER','VITE_REVERB_APP_KEY','VITE_REVERB_HOST','VITE_REVERB_PORT',
'VITE_REVERB_SCHEME',);
